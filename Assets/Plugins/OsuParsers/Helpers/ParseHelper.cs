    ...
    internal static class ParseHelper
    {
        ...
        public static List<Vector2> GetSliderPoints(string[] segments)
        {
            ...
            foreach (string segmentPos in segments.Skip(1))
            {
                ...
                {
                    UnityEngine.Debug.Log($"POSTO: {segmentPos}");
                    Convert.ToDouble(positionTokens[0], CultureInfo.InvariantCulture);
                    ...
                    sliderPoints.Add(new Vector2(
                        (int)Convert.ToDouble(positionTokens[0], CultureInfo.InvariantCulture),
                        (int)Convert.ToDouble(positionTokens[1], CultureInfo.InvariantCulture)));
                }
            }
            return sliderPoints;
        }
